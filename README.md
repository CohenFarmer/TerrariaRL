...
2. Install .NET 8 SDK
3. Copy `mod/` contents to `Documents/My Games/Terraria/tModLoader/ModSources/TerrariaRL/`
4. In tModLoader: Workshop → Develop Mods → Build + Reload

### Python
```bash
pip install gymnasium numpy torch
python env/test_connection.py
```
